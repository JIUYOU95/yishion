...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="/node_modules/hdjs/css/bootstrap.min.css">
    <style>
...
<pager-bar conf="paginationConf"></pager-bar>

<script src="/node_modules/hdjs/js/angular.min.js"></script>
<script src="/Public/js/PagerBar/pagerBar.js"></script>
<script>
    angular.module('myApp', ['pager']).controller('testController', function($scope, $timeout){
        /**
